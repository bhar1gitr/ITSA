...
const AboutList = () => {
  return (
   ...
   <ul>
    <li>
Air Conditioned Classrooms and Tutorial Rooms equipped with LCD Projectors and Smartboards.</li>
    ...
    <hr></hr>
<div>Computational Facility available with the Department:</div>
